...
const generarOrden = () => {
    ...
    const order = {
        ...
        items: cart.map(item => ({id:item.id, title:item.nombre, cantidad: item.cantidad,
             precio:item.precio, price_total: item.cantidad * item.precio})),
        total: sumTotal(),
    ...
    addDoc(ordersCollection, order).then((snapShot) => {
        ...
        cart.forEach(item => {
            let producto = doc(db, "articulos", item.id);
                        ...
                        <tbody>
                            {cart.map(item => (
                                <tr key={item.id}>
                                    ...
                                    <td className="align-middle text-end">${item.cantidad * item.precio}</td>
                                </tr>
                                ))
                            }
                            <tr>
