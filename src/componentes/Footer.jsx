        ...
        <div className="container py-3">
            <div className="row">
                ...
                <div className="col-md-6 d-flex justify-content-end">
                    <a href="https://apps.apple.com/us/app/apple-store/id375380948/" target="_blank" className="mx-1"><img src="imagenes/app-store.png" alt="App Store" width="115" /></a>
                    <a href="https://play.google.com/store/apps?hl=es_AR" target="_blank" className="mx-1"><img src="imagenes/play-store.png" alt="Play Store" width="115" /></a>
                </div>
            </div>
            <hr />
            <div className="row">
